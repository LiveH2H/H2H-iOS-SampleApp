...
@interface CombinedChartView : BarLineChartViewBase <BarChartDataProvider, CandleChartDataProvider, BubbleChartDataProvider, LineChartDataProvider, ScatterChartDataProvider>
- (void)initialize;
@property (nonatomic, strong) ChartData * _Nullable data;
